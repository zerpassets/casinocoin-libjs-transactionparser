...
function casinocoinToUnixTimestamp(rpepoch) {
...
function getExpirationTime(node) {
    ...
    return (new Date(casinocoinToUnixTimestamp(expirationTime))).toISOString();
}
 ...
 * Returns changes grouped by Casinocoin account.
 *
 *  @param {Object} metadata - Transaction metadata as return by casinocoin-libjs
 *  @returns {Object} - Orderbook changes grouped by Casinocoin account
 *
 */
